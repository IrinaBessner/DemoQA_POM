...
public class PracticeFormPage extends BasePage {
    ...
    public PracticeFormPage enterBirthDay(String date) {
        // focus on teh field - кликаем в поле
        click(dateOfBirthInput);
        //создаем переменную для выбора операционной системы
        String os = System.getProperty("os.name");
        System.out.println("My OS is " + os);
        // press on the keyboard 2 keys : "CONTROL" for Windows or "COMMAND" for  Mac
        ...
        //press on teh keyboards the key "ENTER"
